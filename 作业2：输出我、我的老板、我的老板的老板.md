...
```SQL
	...
	CREATE TABLE t_employee2 (	# 创建一个雇员表
    	deptno INT NOT NULL,
...
INSERT INTO t_employee2 (empno, ename, job, MGR, Hiredate, sal, comm, deptno)  # 给雇员表插入记录
...
![](https://github.com/BiubiuOoo/Homework-of-MySQL/blob/master/images/29.png?raw=true)
